...
namespace NSE.Carrinho.WebAPI.Migrations
{
    ...
    [Migration("20230310023515_CarrinhoCascadeDeleteEnable")]
    partial class CarrinhoCascadeDeleteEnable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSE.Carrinho.WebAPI.Model.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NSE.Carrinho.WebAPI.Model.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NSE.Carrinho.WebAPI.Model.CarrinhoCliente", b =>
                {
                    b.OwnsOne("NSE.Carrinho.WebAPI.Model.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("NSE.Carrinho.WebAPI.Model.CarrinhoItem", b =>
                {
                    b.HasOne("NSE.Carrinho.WebAPI.Model.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
